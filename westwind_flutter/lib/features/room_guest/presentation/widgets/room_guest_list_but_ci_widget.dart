...
class RoomGuestListButCIWidget extends StatefulWidget {
  const RoomGuestListButCIWidget({super.key});

  @override
  State<RoomGuestListButCIWidget> createState() => _RoomGuestListButCIWidgetState();
}

class _RoomGuestListButCIWidgetState extends State<RoomGuestListButCIWidget> {
  ...
  void initState() {
    super.initState();
    context.read<RoomGuestListBloc>().add(FetchRoomGuestsButCIEvent());
    _initColumns();
  }
