...
class RoomGuestListButCOWidget extends StatefulWidget {
  const RoomGuestListButCOWidget({super.key});

  @override
  State<RoomGuestListButCOWidget> createState() => _RoomGuestListButCOWidgetState();
}

class _RoomGuestListButCOWidgetState extends State<RoomGuestListButCOWidget> {
