    ...
    return Scaffold(
              ...
              onPressed: () {
                ...
                if (formkey.currentState!.validate()) {
                  ...
                  final roomGuest = RoomGuest(
                    ...
                    stateDate:
                        formkey.currentState!.fields['stateDate']!.value,
                    updateDate:
        ...
        body: BlocConsumer<RoomGuestManageBloc, RoomGuestManageState>(
          ...
          listener: (context, state) {
            ...
            if (state is RoomGuestManageStateFailure) {
              ...
              rateReasonController.text =
                  state.roomGuest.rateReason.toString();
          ...
          //    context.read<RoomGuestManageBloc>().add( CalculateRate(type: type, reason: reason) );
              ...
              firstNameController.text = state.roomGuest.guest!.firstName;
              lastNameController.text = state.roomGuest.guest!.email;
              rigNumberController.text = state.roomGuest.guest!.rigNumber.toString();
