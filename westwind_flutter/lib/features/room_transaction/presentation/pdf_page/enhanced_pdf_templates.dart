...
/// Collection of PDF templates using the enhanced generator with multi-column support
class EnhancedPdfTemplates {
  
  /// Template for room transactions invoice
  static EnhancedPdfContentConfig<RoomTransaction> getRoomTransactionInvoiceConfig({
    bool includeAllTransactions = true,
    bool enableColumnOverflow = false,
    int columnCount = 2,
    bool fillColumnVertically = true,
  }) {
    return EnhancedPdfContentConfig<RoomTransaction>(
      ...
      // Enable multi-column overflow
      enableColumnOverflow: enableColumnOverflow,
      columnCount: columnCount,
      fillColumnVertically: fillColumnVertically,
  ...
  static EnhancedPdfContentConfig<RoomTransaction> getNightAuditConfig({
    bool enableColumnOverflow = false,
    int columnCount = 2,
    bool fillColumnVertically = true,
  }) {
  ...
  static EnhancedPdfContentConfig<RoomGuest> getRoomGuestConfig({
    bool enableColumnOverflow = false,
    int columnCount = 2,
    bool fillColumnVertically = true,
  }) {
    return EnhancedPdfContentConfig<RoomGuest>(
      title: 'Westwind Motor Inn',
