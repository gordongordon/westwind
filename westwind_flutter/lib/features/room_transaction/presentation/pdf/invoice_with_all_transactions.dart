...
Future<Uint8List> generateInvoiceWithAllTransactions(
...
/*
  ...
  */
  ...
  final invoice = InvoiceWithAllTransactions(
...
class InvoiceWithAllTransactions {
  InvoiceWithAllTransactions({
...
//  double get _subAmount =>
  ...
  //    roomTransactions.map<double>((p) => p.amount).reduce((a, b) => a + b);
  double get _taxableSales =>
      roomTransactions.map<double>((p) => p.amount).fold(0, (a, b) => a + b);
                    ...
                    child: pw.DefaultTextStyle(
                      ...
                      child: pw.GridView(
                        ...
                        children: [
                          ...
                          pw.Text('$invoiceNumber-${invoiceDay}A'),
                          pw.Text('Date:'),
